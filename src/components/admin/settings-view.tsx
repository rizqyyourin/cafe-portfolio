...
export function SettingsView({ data, saveSettingsAction }: { data: CafeSettings; saveSettingsAction: SettingsAction }) {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    for (const field of ["cafeName", "tagline", "description", "address", "phone", "whatsapp", "email", "instagram", "threads", "twitter", "tiktok", "facebook", "mapsUrl"] as const) formData.set(field, formState[field] ?? "");
